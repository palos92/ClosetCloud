...
elseif($_POST["enviarProducte"]){
      $nomproducto = $_POST["nombrePro"];
      $precioproducto = $_POST["precioPro"];
      $imagenproducto = $_POST["imagenPro"];
      $stockproducto = $_POST["stockPro"];
      $descripcioproducto = $_POST["descripcionPro"];
      $categoriaproducto = $_POST["categoriaPro"];
      $tallaproducto = $_POST["tallaPro"];
      $perfilProducto = $_POST["perfilPro"];
      $connexio->consultar("INSERT INTO t_producto VALUES (,'$nomproducto','$precioproducto','$imagenproducto','$stockproducto','$descripcioproducto','$categoriaproducto','$tallaproducto','$perfilProducto')");
      header("location:../vista/admin/anadirProducto.php");
}
else
{
